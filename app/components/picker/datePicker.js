...
export class DatePicker extends React.Component {
  ...
  constructor(props) {
    ...
    this.years = this.generateArrayFromRange(1900, 2030);
  ...
  render() {
    ...
    let selectedOptions = [ selectedDay || 1, selectedMonth || 1, selectedYear||2000];
    if (customDateParts) {
      selectedOptions = [];
      data = [];
      ...
      if (customDateParts.includes(DatePicker.DatePart.MONTH)) {
        ...
        selectedOptions.push(selectedMonth|| 1);
      }
